      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-6 text-base leading-relaxed text-gray-700">
          <div className="lg:col-span-2 lg:row-span-2 bg-white border border-gray-200 p-6 rounded-2xl hover:scale-105 transition-all duration-300">
            ...
            <p>
              Наши центры семейного здоровья открыты в сёлах Байкент, Кызыл Кайрат, Достык и в селе им. К. Ултаркова. Мы позаботились о том, чтобы получение медицинской помощи нашими пациентами проходило в максимально комфортных условиях.
            </p>
          </div>
