...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f9fbfc] py-16 px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-center mb-12 text-[#20aa99]">Контакты</h1>
      <p className="text-center text-lg text-gray-600 mb-16 max-w-2xl mx-auto">
        Ниже представлены филиалы нашей клиники. Нажмите на интересующий филиал, чтобы увидеть подробную информацию.
      </p>
        ...
        {clinics.map((clinic) => (
          ...
          >
            <div className="flex items-center mb-4">
              <Image src="/assets/logo.png" alt="logo" width={40} height={40} className="mr-3" />
              <h3 className="text-lg font-semibold text-[#20aa99]">{clinic.name}</h3>
            </div>
      ...
      {selectedClinic && (
        ...
        >
          <div className="bg-white rounded-2xl p-6 max-w-2xl w-full relative shadow-2xl">
            ...
            <h2 className="text-2xl font-bold text-[#20aa99] mb-4">{selectedClinic.name}</h2>
            <p className="text-gray-700 mb-2"><strong>📍 Адрес:</strong> {selectedClinic.address}</p>
            <p className="text-gray-700 mb-2"><strong>📞 Телефон:</strong> {selectedClinic.phone}</p>
            <p className="text-gray-700 mb-4"><strong>🗓️ График работы:</strong> {selectedClinic.date}</p>
